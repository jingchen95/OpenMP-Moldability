...
#define PERF_THRESHOLD 0.2 //Allow the execution time fluctuation to be within 10% of the average, if exceeds 10% then we detect the performance interference on the thread
#define CHECK_INTERVAL 10 // check the interfernce every 10 seconds
