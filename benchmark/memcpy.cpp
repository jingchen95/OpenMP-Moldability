...
#define R1 64            // number of rows in Matrix-1
#define C1 64            // number of columns in Matrix-1
#define R2 64            // number of rows in Matrix-2
#define C2 64            // number of columns in Matrix-2
...
int main(int argc, char* argv[]) {
    ...
    std::uint64_t SIZE_BYTES = 1073741824;
